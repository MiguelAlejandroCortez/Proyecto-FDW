...
<h1>MERCANCIA DE ENGINEERING SUPPLIES</h1>

<?php
$producto = "MERCHANDISE SUPPLIES";
...
foreach($productos as $producto){
    ...
    echo '<img height="300" width="200" src="data:image/;base64,' . base64_encode($producto['foto']) . '" alt=""><br>';
